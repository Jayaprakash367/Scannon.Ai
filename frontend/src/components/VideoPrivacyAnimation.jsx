...
const VideoPrivacyAnimation = () => {
  ...
  return (
    <div className="relative w-full h-96 bg-zinc-100 border border-zinc-200 rounded-2xl overflow-hidden shadow-xs">
      {/* Grid Pattern */}
        ...
        >
          ...
          <div className="w-full h-full relative">
            ...
            <motion.div
              ...
              className="absolute inset-0 rounded-full bg-zinc-900/20 backdrop-blur-xl"
            />
          </div>
        </motion.div>
      ))}
      ...
      <motion.div
        ...
        className="absolute left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-black to-transparent opacity-60"
      />
    </div>
  );
};
